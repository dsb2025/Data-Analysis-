...
class BST(object):
    ...
    def is_similar(self, compTree):
        def is_similar_helper(first, second):
            ...
            return (first.data == second.data) and is_similar_helper(first.left, second.left) and is_similar_helper(first.right, second.right)

        return is_similar_helper(self.root, compTree.root)
